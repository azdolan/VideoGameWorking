...
public class KeyChest2 : MonoBehaviour
{
    public Animator animator;
    public Transform chestPoint;
    public float chestRange;
    public LayerMask keyChest2Layer;
    ...
    {
        Collider2D[] chests = Physics2D.OverlapCircleAll(chestPoint.position, chestRange, keyChest2Layer);
